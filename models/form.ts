...
import { BaseComponentProps, BaseComponentWithChildren, BaseComponentWithClassName } from "./base";

/**
 * Base props for form label components (Input.Label and Select.Label)
 * Used by components that display labels for form fields
 */
export interface FormLabelProps extends BaseComponentProps, BaseComponentWithChildren, LabelHTMLAttributes<HTMLLabelElement> { }
 ...
 */
export interface FormErrorProps extends BaseComponentProps, BaseComponentWithChildren, BaseComponentWithClassName {
