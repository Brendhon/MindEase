...
export const styles = {
  ...
  contrast: {
    ...
    high: {
      ...
      focus: "data-[focus]:ring-4 data-[focus]:ring-action-primary/50 data-[focus]:outline data-[focus]:outline-2 data-[focus]:outline-offset-2 data-[focus]:outline-action-primary/30",
    },
  } as const,
} as const;
