...
export const styles = {
  container:
    'fixed bottom-4 right-4 z-50 w-72 bg-surface-primary cursor-pointer hover:bg-surface-secondary transition-all duration-normal',
  ...
  minimizeButton:
    'flex-shrink-0 p-1 cursor-pointer rounded hover:bg-surface-secondary transition-colors duration-fast text-text-secondary hover:text-text-primary focus:outline-none focus:ring-2 focus:ring-action-primary focus:ring-offset-2',
  ...
  timerContainer:
    'mt-2 pt-2 border-t border-border-subtle flex items-center justify-end',
