...
export const styles = {
  // Banner base styles
  banner:
    'flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 rounded-lg bg-surface-primary border-2 border-action-warning/50 shadow-soft',
  ...
  dismissButton:
    'flex items-center justify-center w-8 h-8 rounded-md hover:bg-action-info/20 transition-colors focus:outline-none focus:ring-2 focus:ring-action-info focus:ring-offset-2',
