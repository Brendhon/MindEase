...
export function ProfileInfoRow({
  ...
  const rowClasses = useMemo(
    () => cn(styles.infoRow, spacingClasses.gap, animationClasses, className),
    [spacingClasses.gap, animationClasses, className]
  );

  const labelClasses = useMemo(
    () => cn(styles.label, fontSizeClasses.sm, labelClassName),
    [fontSizeClasses.sm, labelClassName]
  );

  const valueClasses = useMemo(
    () => cn(styles.value, fontSizeClasses.base, valueClassName),
